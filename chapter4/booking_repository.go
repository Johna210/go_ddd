...
// One Mistake we often make with repository layers is to make one
// struct per database table. This should be avoided
// instead aim to make one struct per aggregate
